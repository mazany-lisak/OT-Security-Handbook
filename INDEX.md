...
*Generated: 2026-07-07 · 61 documents · 8 planned · machine-readable manifest: [index.yaml](index.yaml)*
...
| [OT-Protocols.md](04-Network/OT-Protocols.md) | 1.3.3 | Security reference for industrial protocols — Modbus, S7comm, PROFINET, EtherNet/IP (CIP), OPC UA/DA, POWERLINK, DNP3, IEC 60870-5-104, IEC 61850, MQTT — with default ports, DPI, monitoring and platform notes (S7-1500, M580, Twido, X20). |
...
| Document | Version | Summary |
|---|---|---|
| [PI-System.md (AVEVA)](08-Technologies/AVEVA/PI%20System/PI-System.md) | 1.0.1 | Security architecture and engineering reference for the AVEVA PI System (formerly OSIsoft PI): Data Archive, Asset Framework, PI Interfaces/Connectors and buffering, PI Vision and PI Web API, the estate-wide-aggregation threat model, PI Trusts vs Identity-based authentication, IDMZ placement and PI-to-PI replication, phased hardening, monitoring, backup and cloud integration. |
| [PlantSCADA.md (AVEVA)](08-Technologies/AVEVA/PlantSCADA/PlantSCADA.md) | 2.0.1 | Security architecture and engineering reference for AVEVA Plant SCADA (formerly Citect): component and redundancy architecture, threat model, identity model (roles, privilege levels, areas, Windows/AD integration), Cicode and CtAPI governance, phased hardening, communications security, monitoring, backup and recovery. |
...
| [BR-X20.md (B&R Industrial Automation)](08-Technologies/B&R/X20/BR-X20.md) | 1.0.0 | Security architecture and engineering reference for the B&R (ABB) X20 modular PLC/controller system: architecture and CPU generations, POWERLINK/OPC UA/Modbus communications, threat model, identity and user management, phased hardening, Automation Studio / Automation Runtime governance, firmware and certificate handling, monitoring, backup and IEC 62443 alignment. |
...
| [Kepware-Server.md (PTC)](08-Technologies/PTC/Kepware%20Server/Kepware-Server.md) | 1.0.0 | Security architecture and engineering reference for the PTC Kepware Server (KEPServerEX) OPC aggregation platform: plugin-driver architecture, the OPC DA/DCOM legacy problem, OPC UA and IoT Gateway (MQTT/REST/ThingWorx) northbound paths, the bidirectional-write threat model, user management, phased hardening, monitoring, backup and IEC 62443 conduit placement. |
...
| [GeoSCADA.md (Schneider Electric)](08-Technologies/Schneider%20Electric/GeoSCADA/GeoSCADA.md) | 1.0.0 | Security architecture and engineering reference for EcoStruxure Geo SCADA Expert (formerly ClearSCADA), the wide-area telemetry SCADA: integrated-server architecture, WAN/field trust model, threat model for distributed RTU estates, identity and per-object permissions, telemetry-protocol security (DNP3 SA, IEC 60870-5-104), phased hardening, monitoring, backup and disaster recovery. |
...
Referenced by the corpus and reserved in the tree; create at the listed path to make existing links resolve.

| Document | Planned path | Referenced by | Summary |
|---|---|---|---|
| OPC-UA.md | `04-Network/OPC-UA.md` | Zero-Trust-in-OT.md, OT-Protocols.md, Logging.md, Monitoring.md, Identity-Management.md, PKI.md, Certificates.md, MFA.md, PlantSCADA.md | OPC UA security deep-dive: security profiles (None/Sign/SignAndEncrypt), certificate and trust-list management, node-level access control. |
| Automation-Studio.md | `08-Technologies/B&R/Automation-Studio/Automation-Studio.md` | OT-Protocols.md | B&R Automation Studio engineering-platform security and governance. |
| Detection-Engineering.md | `09-Operations/Detection-Engineering.md` | Logging.md | Designing, testing and maintaining detection rules mapped to ATT&CK for ICS. |
| FAT.md | `09-Operations/FAT.md` | OT-Lifecycle.md | Factory Acceptance Test: security validation scope and procedures before shipment. |
| Risk-Assessment.md | `09-Operations/Risk-Assessment.md` | OT-Security-Philosophy.md, Risk-Management-Principles.md, Risk-Based-Security.md, Security-Decision-Framework.md | Operational execution of risk assessment: running assessments, maintaining the risk register, periodic reassessment (IEC 62443-2-1 / 62443-3-2). |
| SAT.md | `09-Operations/SAT.md` | OT-Lifecycle.md | Site Acceptance Test: on-site functional and security validation before handover to operations. |
| Threat-Hunting.md | `09-Operations/Threat-Hunting.md` | Logging.md | Proactive, behaviour-driven investigation in OT telemetry beyond automated detection. |
| Windows-Hardening.md | `09-Operations/Windows-Hardening.md` | OT-Protocols.md | Hardening of Windows hosts in OT (SCADA servers, engineering workstations, historians); required context for OPC DA / DCOM environments. |
